...
class _CircularPageState extends State<CircularPage>
  ...
  void initState() {
    ...
    Timer(Duration(seconds: 5), () {
      print(otp);
      Navigator.of(context).pushNamed("otppage", arguments: otp);
    });
  }
...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    Paint Circle_1 = Paint()..color = Colors.green;

    Paint Circle_2 = Paint()..color = Colors.blue;
